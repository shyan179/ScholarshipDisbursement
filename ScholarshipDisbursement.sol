...
//import "./PriceConvert.sol"; <!--This only relevant on rinkeby testnet-->
...
contract ScholarDetails {
	...
	{	//Convert the amount from GBP to wei
		...
		require(_Amount <= address(this).balance,"____This wallet does not have enough balance to offer the scholarship____");
		...
		scholarship.push(Scholarship({ID: _ID, ScholarshipName: _ScholarshipName, 
									Amount: _Amount, Provider: provAdd, 
